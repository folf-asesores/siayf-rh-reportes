/*
 * ProductoNominaFederalQuery.java
 ...
 */
public class ProductoNominaFederalQuery implements Serializable {
    
    private static final long serialVersionUID = -3622224990346218269L;
    private static final Logger LOGGER = Logger.getLogger(ProductoNominaFederalQuery.class.getName());
