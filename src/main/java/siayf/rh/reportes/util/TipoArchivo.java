/*
 * TipoArchivo.java
 * Creado el 31/oct/2017 6:22:29 PM
 * 
 */
...
public enum TipoArchivo {
     ...
     * 
     * @param MIMEType la cadena que representa el MIMEType.
     * @param extension la extensión que corresponde al MIMEType.
     */
    ...
    public static TipoArchivo getTipoArchivoPorExtension(final String extension) {
        ...
        Pattern pattern = Pattern.compile(PATRON_EXTENSION_ARCHIVO);
    ...
    private static final String PATRON_EXTENSION_ARCHIVO = "([^\\s]+(\\.(?i)([\\w]{3,5}))$)";
