/*
 * DispersionExcel.java
 * Creado el 27/ene/2017 3:50:05 AM
 *
 */
 ...
 */
public class DispersionExcel extends ExcelReporte implements Serializable {

    private static final long serialVersionUID = 1631844841209324430L;
    private static final Logger LOGGER = Logger.getLogger(DispersionExcel.class.getName());

    public DispersionExcel() {
    }
    ...
    protected void llenarDetalles(List<DispersionDto> detalles) {
    ...
    private String obtenerLeyenda(Date fecha) {
        ...
        MessageFormat messageFormat = new MessageFormat(patron, FechaUtil.LUGAR_MEXICO);
